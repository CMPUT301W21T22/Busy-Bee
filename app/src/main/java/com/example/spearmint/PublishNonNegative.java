...
/**
 * Fragment that allows a user to publish an non-negative trial with a description, value that is incremented or decremented
 ...
 * has two clickable buttons called "publish" or "cancel", once either is pressed, the user is redirected to experiment_nonnegative.java
